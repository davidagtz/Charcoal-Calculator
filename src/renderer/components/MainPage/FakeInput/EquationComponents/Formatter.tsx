...
export function charFormat(tree: (ParseNode | null)[], id: string = ''): JSX.Element {
    return (
...
function _charFormat(tree: ParseNode | null, key?: number): JSX.Element | null {
    ...
    if (tree.type === TYPE.UNKNOWN) return <Value value={tree.value} key={key} />;
